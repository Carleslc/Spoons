...
--- Method
--- Generates a random password and copies it to the clipboard. This method uses only alphanumeric characters: ABCDEFGHIJKLMNPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz123456789 Excludes similar characters like O and 0
---
--- Parameters:
---  * length - Password length. Defaults to 8.
...
--- Method
--- Generates a random password and copies it to the clipboard. This method can use special characters: ABCDEFGHIJKLMNPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz123456789!\\#$%&()*+-./<=>?@[]^_{}~ Excludes similar characters like O and 0 or ' and " or : and ; and ,
---
--- Parameters:
---  * length - Password length. Defaults to 8.
---  * chars - Optional charset. If filled then only this charset is used.
